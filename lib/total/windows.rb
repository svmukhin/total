...
module Total
  ...
  class Windows
    ...
    def memory
      ...
      begin
        output = `powershell.exe -Command "Get-WmiObject \
          -Class Win32_ComputerSystem | Select-Object -ExpandProperty \
          TotalPhysicalMemory" 2>NUL`.strip
      ...
      begin
        ...
        output.split("\n").each do |line|
          ...
          memory_str = ::Regexp.last_match(1).strip
